  			...
  			<tr>
  				...
  				<td>
  					...
  					<input type="checkbox" name="preference" value="乒乓球" 
  						<c:if test="${fn:contains(preference,'乒乓球') }">checked='checked'</c:if>
  					/>乒乓球
  					<input type="checkbox" name="preference" value="玻璃球" 
  						<c:if test="${fn:contains(preference,'玻璃球') }">checked='checked'</c:if>
  					 />玻璃球
  					<input type="checkbox" name="preference" value="铅球" 
  						<c:if test="${fn:contains(preference,'铅球') }">checked='checked'</c:if>
  					/>铅球
  				</td>
  			</tr>
  			<tr>
